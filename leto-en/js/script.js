...
document.querySelectorAll('.button-catalog').forEach((el) => {
    el.addEventListener('click', () => {
        ...
        if(content.style.maxHeight) {
            document.querySelectorAll('.catalog-list__more').forEach((el) => el.style.maxHeight = null)
        } else {
            document.querySelectorAll('.catalog-list__more').forEach((el) => el.style.maxHeight = null)
            content.style.maxHeight = content.scrollHeight + 'px'
            el.classList.add('button-none')
        }
    })
})
